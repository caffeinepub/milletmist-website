...
const AboutUs = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "py-20 md:py-32 gradient-warm", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-3xl mx-auto text-center mb-16", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-serif text-4xl md:text-5xl font-bold text-foreground mb-6", children: [
        "About ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary", children: "Raavni Agrobyte" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg text-foreground/70 leading-relaxed", children: "Raavni Agrobyte (OPC) Pvt. Ltd. is a pioneering women-led organization dedicated to revolutionizing nutrition through the ancient wisdom of millets. Our brand, Milletmist, represents our commitment to health, sustainability, and community empowerment." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid md:grid-cols-2 gap-12 items-center mb-20", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "order-2 md:order-1", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-serif text-3xl font-bold text-foreground mb-4", children: "Powered by Women, For Everyone" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-foreground/70 mb-4 leading-relaxed", children: "At the heart of Raavni Agrobyte is an all-women core team of passionate entrepreneurs, nutritionists, and social change-makers. We believe that when women lead, communities thrive." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-foreground/70 mb-4 leading-relaxed", children: "Our journey began with a simple vision: to bring the incredible health benefits of millets to modern consumers while creating sustainable livelihoods for the farmers who grow them." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-foreground/70 leading-relaxed", children: "Every Milletmist product is a testament to our commitment to quality, sustainability, and the empowerment of women and farming communities across India." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "order-1 md:order-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-2xl overflow-hidden shadow-warm", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        "img",
        {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid sm:grid-cols-2 lg:grid-cols-4 gap-6", children: values.map((value) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      Card,
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "p-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-12 w-12 rounded-xl bg-primary/10 flex items-center justify-center mb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(value.icon, { className: "h-6 w-6 text-primary" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-serif text-xl font-bold text-foreground mb-2", children: value.title }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-foreground/70 leading-relaxed", children: value.description })
        ] })
      },
      value.title
    )) })
...
const Contact = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "py-20 md:py-32 bg-background", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-3xl mx-auto text-center mb-16", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-serif text-4xl md:text-5xl font-bold text-foreground mb-6", children: [
        "Get In ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary", children: "Touch" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg text-foreground/70 leading-relaxed", children: "Have questions about our products or want to learn more about our farmer support initiatives? We'd love to hear from you." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid md:grid-cols-3 gap-8 max-w-5xl mx-auto", children: contactInfo.map((info) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      Card,
      {
        className: "border-2 hover:border-primary/50 transition-all hover:shadow-warm",
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "p-6 text-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-14 w-14 rounded-xl bg-primary/10 flex items-center justify-center mx-auto mb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(info.icon, { className: "h-7 w-7 text-primary" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-serif text-xl font-bold text-foreground mb-3", children: info.title }),
          info.details.map(
            (detail, idx) => info.link && idx === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(
              "a",
              {
                href: info.link,
              ...
              detail
            ) : info.link && idx === 1 && info.icon === Mail ? /* @__PURE__ */ jsxRuntimeExports.jsx(
              "a",
              {
                href: `mailto:${detail}`,
                className: "block text-foreground/70 text-sm hover:text-primary transition-colors",
              ...
              detail
            ) : /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-foreground/70 text-sm", children: detail }, detail)
          )
        ] })
      },
      info.title
    )) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-16 text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "inline-block p-8 rounded-2xl gradient-warm border-2 border-primary/20 max-w-2xl", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-serif text-2xl font-bold text-foreground mb-3", children: "Join Our Journey" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-foreground/70 leading-relaxed", children: "Whether you're a health-conscious consumer, a potential partner, or someone who shares our vision for sustainable agriculture and women empowerment, we welcome you to be part of the Milletmist family." })
    ] }) })
  ] }) });
};
const CoreTeam = () => {
  const founderImageRef = reactExports.useRef(null);
  const productLeadImageRef = reactExports.useRef(null);
  const operationsLeadImageRef = reactExports.useRef(null);
  const kumariImageRef = reactExports.useRef(null);
  reactExports.useEffect(() => {
    for (const ref of [
      founderImageRef,
      productLeadImageRef,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "py-20 md:py-32 bg-background", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-3xl mx-auto text-center mb-16", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-serif text-4xl md:text-5xl font-bold text-foreground mb-6", children: [
        "Meet Our ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary", children: "Core Team" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg text-foreground/70 leading-relaxed", children: "The passionate women leaders driving Milletmist's mission to revolutionize nutrition and empower communities through sustainable agriculture." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid sm:grid-cols-2 lg:grid-cols-4 gap-8", children: teamMembers.map((member) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      Card,
      {
        className: "border-2 hover:border-primary/50 transition-all hover:shadow-warm group",
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "p-6", children: [
          member.image && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-6 relative overflow-hidden rounded-xl", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            "img",
            {
            ...
            `${member.role}-${Date.now()}`
          ) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-serif text-xl font-bold text-foreground mb-1", children: member.name }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-medium text-primary mb-3", children: member.role }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-foreground/70 leading-relaxed mb-4", children: member.description }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                ...
                children: /* @__PURE__ */ jsxRuntimeExports.jsx(Linkedin, { className: "h-4 w-4 text-primary" })
              }
            ) })
          ] })
        ] })
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-3xl mx-auto text-center mt-16", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-primary/5 rounded-2xl p-8 border-2 border-primary/20", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg text-foreground/80 leading-relaxed italic", children: `"Together, we're not just building a brand—we're creating a movement that celebrates women's leadership, honors traditional wisdom, and builds a healthier, more sustainable future."` }) }) })
  ] }) });
};
const FarmerSupport = () => {
  const impacts = [
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "py-20 md:py-32 gradient-sage", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-3xl mx-auto text-center mb-16", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-serif text-4xl md:text-5xl font-bold text-foreground mb-6", children: [
        "Supporting ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-secondary", children: "Millet Farmers" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg text-foreground/70 leading-relaxed", children: "At the heart of Milletmist is our commitment to the farmers who grow these incredible grains. We believe that sustainable business means uplifting the communities that make our products possible." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid md:grid-cols-2 gap-12 items-center mb-16", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "order-2 md:order-1", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-2xl overflow-hidden shadow-sage", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        "img",
        {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "order-1 md:order-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-serif text-3xl font-bold text-foreground mb-4", children: "Empowering Ultra-Poor Farmers" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-foreground/70 mb-4 leading-relaxed", children: "Many millet farmers in India belong to economically disadvantaged communities. Despite growing one of the world's most nutritious crops, they often struggle with poverty due to unfair market practices." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-foreground/70 mb-4 leading-relaxed", children: "Milletmist is changing this narrative. We partner directly with ultra-poor farmers, offering them fair prices, advance payments, and the dignity they deserve. Every product you purchase directly supports these farming families." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-foreground/70 leading-relaxed", children: "Together, we're not just building a business—we're building a movement for social justice, environmental sustainability, and economic empowerment." })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid sm:grid-cols-2 lg:grid-cols-4 gap-6", children: impacts.map((impact) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      Card,
      {
        className: "border-2 hover:border-secondary/50 transition-all hover:shadow-sage",
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "p-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-12 w-12 rounded-xl bg-secondary/10 flex items-center justify-center mb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(impact.icon, { className: "h-6 w-6 text-secondary" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-serif text-xl font-bold text-foreground mb-2", children: impact.title }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-foreground/70 leading-relaxed", children: impact.description })
        ] })
      },
      impact.title
    )) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-16 text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "inline-block p-8 rounded-2xl bg-background/50 border-2 border-secondary/20", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xl font-medium text-foreground mb-2", children: "Every purchase makes a difference" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-foreground/70", children: "When you choose Milletmist, you're choosing to support sustainable farming and empower communities." })
    ] }) })
  ] }) });
};
const Footer = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "bg-muted/30 border-t border-border py-8", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container mx-auto px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col md:flex-row items-center justify-between gap-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-serif text-lg font-bold text-foreground", children: "Raavni Agrobyte" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-foreground/60", children: "by Raavni Agrobyte (OPC) Pvt. Ltd." })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center md:text-right", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm text-foreground/70 mb-1", children: [
        "© ",
        currentYear,
        " Raavni Agrobyte (OPC) Pvt. Ltd. All rights reserved."
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm text-foreground/60 flex items-center justify-center md:justify-end gap-1", children: [
        "Built with",
        " ",
        /* @__PURE__ */ jsxRuntimeExports.jsx(Heart, { className: "h-3.5 w-3.5 text-primary fill-primary inline" }),
        " ",
        "using",
        " ",
        /* @__PURE__ */ jsxRuntimeExports.jsx(
...
const Hero = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative min-h-screen flex items-center justify-center overflow-hidden", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute inset-0 z-0", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-gradient-to-br from-background/95 via-background/85 to-background/70" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container mx-auto px-4 relative z-10 pt-20", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-4xl mx-auto text-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-8 animate-fade-in", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        "img",
        {
          src: "/assets/RaavniLogoWB.png",
          alt: "Raavni Agrobyte Logo",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "font-serif text-5xl md:text-7xl font-bold mb-6 animate-fade-in [animation-delay:200ms]", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-black", children: "Built for Health," }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-black", children: "Designed for Impact" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xl md:text-2xl text-white font-bold mb-8 max-w-2xl mx-auto opacity-0 animate-slide-up [animation-delay:400ms]", children: "Premium Millet Based products crafted with love and care by women, for a healthier you and a sustainable future." }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap justify-center gap-4 mb-10 animate-fade-in [animation-delay:600ms]", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 px-4 py-2 rounded-full bg-primary/80 border-[3px] border-primary", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Leaf, { className: "h-5 w-5 text-white" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-medium text-white", children: "100% Natural Millets" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 px-4 py-2 rounded-full bg-secondary/80 border-[3px] border-secondary", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Heart, { className: "h-5 w-5 text-white" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-medium text-white", children: "Women-Led" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 px-4 py-2 rounded-full bg-accent/80 border-[3px] border-accent", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Heart, { className: "h-5 w-5 text-white" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-medium text-white", children: "Farmer Support" })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row gap-4 justify-center animate-fade-in [animation-delay:800ms]", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute bottom-0 left-0 right-0 h-32 bg-gradient-to-t from-background to-transparent z-10 pointer-events-none" })
  ] });
};
const Navigation = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "nav",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-serif text-2xl font-bold text-primary", children: "Raavni Agrobyte" })
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "hidden md:flex items-center space-x-1", children: navLinks.map((link) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              type: "button",
              onClick: () => scrollToSection(link.id),
              className: `px-4 py-2 rounded-lg text-sm font-medium transition-colors ${activeSection === link.id ? "text-primary bg-primary/10" : "text-foreground/70 hover:text-primary hover:bg-primary/5"}`,
              children: link.label
            },
            link.id
          )) }),
        ...
        isMobileMenuOpen && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "md:hidden py-4 border-t border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col space-y-2", children: navLinks.map((link) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            type: "button",
            onClick: () => scrollToSection(link.id),
            className: `px-4 py-3 rounded-lg text-left font-medium transition-colors ${activeSection === link.id ? "text-primary bg-primary/10" : "text-foreground/70 hover:text-primary hover:bg-primary/5"}`,
            children: link.label
          },
          link.id
        )) }) })
...
const Products = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "py-20 md:py-32 bg-background", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-3xl mx-auto text-center mb-16", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg text-foreground/70 leading-relaxed", children: "Discover the power of millets with our carefully crafted range of protein bars and energy products. Each product is designed to fuel your active lifestyle while supporting sustainable agriculture." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid md:grid-cols-2 gap-8 mb-20", children: products.map((product) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      Card,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(CardHeader, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between mb-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: "font-serif text-2xl", children: product.name }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  className: `h-10 w-10 rounded-lg bg-${product.color}/10 flex items-center justify-center`,
                  children: /* @__PURE__ */ jsxRuntimeExports.jsx(product.icon, { className: `h-5 w-5 text-${product.color}` })
                }
              )
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-foreground/70 leading-relaxed", children: product.description })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-2", children: product.benefits.map((benefit) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Badge,
            {
              variant: "secondary",
              className: "text-xs",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "gradient-sage rounded-2xl p-8 md:p-12", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-4xl mx-auto", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-center mb-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-16 w-16 rounded-2xl bg-secondary/20 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Leaf, { className: "h-8 w-8 text-secondary" }) }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-serif text-3xl font-bold text-center text-foreground mb-4", children: "Why Millets?" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-center text-foreground/70 mb-8 max-w-2xl mx-auto", children: "Millets are ancient supergrains that have nourished civilizations for thousands of years. Rediscover their incredible health benefits." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid sm:grid-cols-2 lg:grid-cols-3 gap-4", children: milletBenefits.map((benefit) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          className: "flex items-start gap-3 p-4 rounded-lg bg-background/50",
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-6 w-6 rounded-full bg-secondary/20 flex items-center justify-center flex-shrink-0 mt-0.5", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-2 w-2 rounded-full bg-secondary" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-foreground/80 leading-relaxed", children: benefit })
          ]
        },
        benefit
      )) })
...
function App() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "about", children: /* @__PURE__ */ jsxRuntimeExports.jsx(AboutUs, {}) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "team", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CoreTeam, {}) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "products", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Products, {}) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "farmer-support", children: /* @__PURE__ */ jsxRuntimeExports.jsx(FarmerSupport, {}) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "contact", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Contact, {}) })
    ] }),
